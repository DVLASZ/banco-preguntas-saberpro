...
| `modulo-revision` | 23 | `Revisor`, `AsignacionRevision`, el repositorio y el correo simulados, `DirectorioRevisoresDeUsuarios`, `FuenteDePreguntasAsignadas` y `AsignacionRevisionService` (una prueba por regla de HU-04) |
