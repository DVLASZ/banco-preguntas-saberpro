...
HU-04"** del mismo archivo:

| Prototipo (marco de Figma) | Historia de usuario |
|---|---|
| HU-01 · Crear pregunta (formulario completo) | HU-01 (criterio 1) |
| HU-01 · Validación estructural: campos en rojo (criterios 2 y 3) | HU-01 (criterios 2 y 3) |
| HU-03 · Mis preguntas (listado, filtros y paginación) | HU-03 |
| HU-02 · Enviar a revisión (confirmación) | HU-02 |
| Revisor · Revisar pregunta (Aprobar/Rechazar) | Flujo posterior a HU-04 |
| HU-04 · Asignación de Revisores (Administrador) | HU-04 (los 4 criterios) |
| Login · Inicio de sesión, Registro · Registro de usuario | Acceso al sistema |
| Dashboard · Tablero (Administrador) | Acceso a HU-04 y a los reportes desde el menú |
| Observer1 · Vista de Estadísticas, Observer2 · Vista Gráfica | Reporte del Administrador (Observer) |
| Microkernel · Generador de preguntas, Docente · Generar Simulacro, Estudiante · Elegir/Presentar simulacro | Fuera del primer corte (Talleres 5 y 6) |
