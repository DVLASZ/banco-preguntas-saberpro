...
| RevisionController | `GUIRevisor`, `RevisionController`, `GUIAsignacionRevisores` | Implementado (HU-04 en desarrollo) |
| SimulacroController | `GUIDocente`, `GUIEstudiante` | Implementado, fuera del primer corte |
| ReporteController | `GUIObserver1`, `GUIObserver2` (estadísticas y gráfica) | Parcial |
...
| RevisionService | `AsignacionRevisionService` | HU-04 |
...
| RevisionRepository | `AsignacionRevisionImplRepository` (memoria) | HU-04 |
